...
<div class="page-heading about-heading header-text"
    style="background:linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.65)), url(<?= base_url('/assets/img/banner.jpeg') ?>); filter: brightness(100%)">
    <div class=" container">
        <div class="row">
            <div class="col-md-12">
                <div class="text-content">
                    <h4>Tentang Petani</h4>
                    <h2><?= $detail_produk->nama_petani; ?></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="right-image">
                    ...
                    <div id="produk<?php echo $detail_produk->id ?>" class="carousel slide">
                        ...
                        <a class="carousel-control-prev" href="#produk<?php echo $detail_produk->id  ?>" role="button"
                            data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="carousel-control-next" href="#produk<?php echo $detail_produk->id  ?>" role="button"
                            data-slide="next">
            ...
            <div class="col-md-6">
                <div class="left-content">
                    <h3>Rp. <?php echo number_format("$detail_produk->harga", 0, ",", "."); ?> <small> / Kg</small>
                    </h3>
                    ...
                    <ul>
                        <li><span style="font-size: 12px; color: Tomato;">
                                <a href="<?= base_url('Customer/pembelian'); ?>//<?php echo $detail_produk->id ?>"
                                    class="filled-button"><i class="fa fa-comments-o"></i> Beli Sekarang</a>
                            </span>
                        </li>
                    </ul>
...
<div class="container">
    ...
    <div class=" row">
        <div class="col-md-1">
            <br>
            <img class="rounded-circle " width="50px" alt="Image placeholder"
