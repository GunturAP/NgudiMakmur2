            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="contact-form">
                        <form method="post" action="<?= base_url('customer/tambah_alamat'); ?>">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12">
                                    <fieldset>
                                        <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama Penerima" required="" value="<?= $info['nama'] ?>">
                                    </fieldset>
                                </div>
                                <div class="col-md-3">
                                    Kota / Kab
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12">
                                    <fieldset>
                                        ...
                                        <input name="kota" type="text" class="form-control" id="kota" placeholder="Nama Kota" required="" hidden>
                                    </fieldset>
                                </div>
                                <div class=" col-md-3">
                                    Kecamatan
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12">
                                    <fieldset>
                                        <input name="kecamatan" type="text" class="form-control" id="email" placeholder="Nama Kecamatan" required="" ">
                                    </fieldset>
                                </div>
                                <div class=" col-md-3">
                                        Detail Lainnya
                                ...
                                <div class="col-lg-8 col-md-12 col-sm-12">
                                    <fieldset>
                                        <input name="no_tlp" type="text" class="form-control" id="no_telp" placeholder="Nomor Whatsapp" pattern="[0-9]+">
                                    </fieldset>
                                </div>
